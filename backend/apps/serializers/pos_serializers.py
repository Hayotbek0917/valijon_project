...
from rest_framework.fields import UUIDField, DecimalField, SerializerMethodField, CharField, BooleanField, IntegerField, \
    DateField
...
from apps.models import (
    ...
    DebtCustomers, CreditTransaction
)
from apps.choice_utils import normalize_choice_label
...
class SupplierCatalogItemSerializer(ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'name', 'default_cost', 'item_type', 'size', 'unit',
...
class SaleSerializer(ModelSerializer):
    ...
    class Meta:
        model = Sale
        fields = ['id', 'branch', 'external_id', 'date', 'time', 'amount', 'method', 'cashier', 'cashier_name', 'items',
                  'lines']
...
class PosCartDraftSerializer(ModelSerializer):
    class Meta:
        model = PosCartDraft
        fields = ['id', 'branch', 'cashier', 'label', 'pay_method', 'customer_name', 'items', 'created_at',
                  'updated_at']
...
class PurchaseOrderSerializer(ModelSerializer):
    ...
    class Meta:
        model = PurchaseOrder
        fields = ['id', 'branch', 'external_id', 'supplier', 'supplier_name', 'date', 'receipt_date', 'total', 'status',
                  'lines']
...
# TO'G'RILANDI: Eski CreditAccount model ziddiyati DebtCustomers'ga almashtirildi
